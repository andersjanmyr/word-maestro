...
(function() {
  ...
  this.WordMaestro = (function() {
    ...
    WordMaestro.prototype.findWord = function(pattern) {
      ...
      if (this.threeOrMoreWildcards(pattern)) {
        return this.grepWord(pattern);
      }
    ...
    WordMaestro.prototype.grepWord = function(pattern) {
      var regex;
    ...
    WordMaestro.prototype.threeOrMoreWildcards = function(pattern) {
      return pattern.split('?').length > 3;
    };
    ...
    WordMaestro.prototype.findPermutedAndShortendWord = function(word) {
      ...
      _ref = this.sort(this.unique(words));
      _results = [];
