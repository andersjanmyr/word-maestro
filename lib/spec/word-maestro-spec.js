...
(function() {
  ...
  describe('WordMaestro', function() {
    beforeEach(function() {
      return this.wm = new WordMaestro(WORDS, 'abcdefghijklmnoprstuvxyzåää', '138113231732312411143878444');
    });
    ...
    describe('findPermutedAndShortendWord', function() {
      return it('should return [tax, ax, ta] for xat', function() {
        return expect(this.wm.findPermutedAndShortendWord('xat')).toEqual(['tax', 'ax', 'ta']);
      });
    });
    describe('findPermutedAndShortendWordSlow', function() {
      return it('should return ten words  for andersek', function() {
        return expect(this.wm.findPermutedAndShortendWord('andersek').length).toEqual(10);
      });
    });
    return describe('calcWordValue', function() {
      return it('should return 12 for zoo', function() {
