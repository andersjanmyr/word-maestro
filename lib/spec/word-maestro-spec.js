...
(function() {
  ...
  describe('WordMaestro', function() {
    beforeEach(function() {
      return this.wm = new WordMaestro(WORDS, 'abcdefghijklmnopqrstuvwxyzåää');
    });
    ...
    describe('findPermutedWord', function() {
      ...
      return it('should return 19 words for ka?o', function() {
    ...
    return describe('findPermutedAndShortendWordSlow', function() {
      return it('should return an [] for andersek', function() {
        return expect(this.wm.findPermutedAndShortendWord('andersek').length).toEqual(13);
      });
    });
  });
