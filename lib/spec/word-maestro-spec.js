(function() {
  describe('WordMaestro', function() {
    ...
    describe('expandPattern', function() {
      it('should return an array with length 29 for one a?', function() {
        return expect(this.wm.expandPattern('a?').length).toBe(29);
      });
      return it('should return an array with length 29*29 for ?a?', function() {
    ...
    return describe('findPermutedAndShortendWord', function() {
      return it('should return an [ax, tax] for xat', function() {
        return expect(this.wm.findPermutedAndShortendWord('xat')).toEqual(['tax', 'ta', 'ax']);
      });
    });
  });
}).call(this);
